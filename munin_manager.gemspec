...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["bin/munin_manager", "bin/runner", "ext/string.rb", "lib/munin_manager/acts_as_munin_plugin.rb", "lib/munin_manager/log_reader.rb", "lib/munin_manager/plugins/haproxy_response_time.rb", "lib/munin_manager/plugins/rails_response_time.rb", "lib/munin_manager/plugins/scribe_net.rb", "lib/munin_manager/plugins/starling_age.rb", "lib/munin_manager/plugins/starling_net.rb", "lib/munin_manager/plugins/starling_ops.rb", "lib/munin_manager/plugins/starling_queue.rb", "lib/munin_manager/plugins.rb", "lib/munin_manager/starling/starling_stats.rb", "lib/munin_manager.rb", "README.markdown"]
  s.files = ["bin/munin_manager", "bin/runner", "ext/string.rb", "lib/munin_manager/acts_as_munin_plugin.rb", "lib/munin_manager/log_reader.rb", "lib/munin_manager/plugins/haproxy_response_time.rb", "lib/munin_manager/plugins/rails_response_time.rb", "lib/munin_manager/plugins/scribe_net.rb", "lib/munin_manager/plugins/starling_age.rb", "lib/munin_manager/plugins/starling_net.rb", "lib/munin_manager/plugins/starling_ops.rb", "lib/munin_manager/plugins/starling_queue.rb", "lib/munin_manager/plugins.rb", "lib/munin_manager/starling/starling_stats.rb", "lib/munin_manager.rb", "Manifest", "munin_manager.gemspec", "Rakefile", "README.markdown", "test/haproxy_response_time_test.rb", "test/log_reader_test.rb", "test/rails_response_time_test.rb", "test/test_helper.rb"]
  s.has_rdoc = true
  s.homepage = %q{}
